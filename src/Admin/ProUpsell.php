...
/**
 * PRO upgrade promotion, shown ONLY on the Subscribe settings screen: a
...
final class ProUpsell
{
    ...
    {
        $default = (string) ($this->data()['url'] ?? 'https://plogins.com/plogins-subscribe-pro/pricing/');
        /**
         * Filters the URL the "Upgrade to PRO" buttons point at.
         *
         * @param string $url Default the Subscribe PRO pricing page.
         */
    ...
    public function banner(): void
    {
        ...
        <div class="subscribe-pro-banner" role="note">
            ...
            <a class="button button-primary subscribe-pro-banner__cta" href="<?php echo esc_url($this->url()); ?>" target="_blank" rel="noopener noreferrer">
                <?php esc_html_e('Upgrade to PRO', 'plogins-subscribe'); ?>
            </a>
    ...
    public function aside(): void
    {
        ...
        <aside class="subscribe-card subscribe-pro-aside" aria-labelledby="subscribe-pro-aside-h">
            ...
            <?php if ($price !== '') : ?>
                <p class="subscribe-pro-aside__price"><?php echo esc_html($price); ?> · <?php esc_html_e('one licence, every PRO feature', 'plogins-subscribe'); ?></p>
            <?php endif; ?>
        </aside>
        <?php
    }
